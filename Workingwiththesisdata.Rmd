...
summary(div_panel_model_filtered$divergence_prop)
...
model_formula_for_vif <- model_formula <- normalized_div_prop ~ fed_rate + trail_1yr + num_funds + avg_size + avg_spread + lag4_nowin_med + AUM_line + log_cum_total_funds + log_current_lag_avg_close_size + log_current_lag_avg_manager_aum
